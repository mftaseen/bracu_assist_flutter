        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildLargeEventCard(context, 'A Festival', 'Brac University A Club', true),
                const SizedBox(height: 16),
                _buildLargeEventCard(context, 'B Festival', 'Brac University B Club', true),
              ],
            ),
          ),
        ],
  ...
  Widget _buildLargeEventCard(BuildContext context, String title, String club, bool isUpcoming) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.blueAccent, width: 2), // to simulate selection if needed
      ),
